...
class RSA_Authenticator(WebAuthnClient, _BaseClient):
    ...
    def do_get_assertion(
        ...
        signature = self.key_share.sign(self.public_key.public_numbers(), padded_hash)

        credential = {"type": "public-key", "id": self.credential_id}

        assertion = AssertionResponse(credential, authenticator_data, signature.xi.to_bytes(256, "big"))
