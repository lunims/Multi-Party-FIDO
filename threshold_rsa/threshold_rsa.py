...
class KeyShare:
    ...
    def __init__(self, players: int, threshold: int, si: int, index: int):
    ...
    def sign(self, pub: rsa.RSAPublicNumbers, digest: bytes):
        """ 
...
class SignShare:
    ...
    def __init__(self, xi: int, index: int, players: int, threshold: int):
        self.xi = xi
        self.index = index
        self.players = players
        self.threshold = threshold
...
class Threshold_RSA:
    ...
    def combine_sign_shares(self, pub: rsa.RSAPublicNumbers, shares: [], msg: bytes):
        """
